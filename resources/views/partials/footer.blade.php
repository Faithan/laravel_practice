    ...
    <div class="container mx-auto py-6 flex-wap flex flex-row gap-10  px-20 w-full justify-center align-center">
        ...
        <div class="flex flex-col items-center text-justify w-1/2">
            ...
            <p class=" my-3 text-xs text-gray-700">
                <b class="text-green-700">SERVIAMUS FOUNDATION INC.</b> is a Diocesan microfinance foundation providing
                financial support to
                women and
                micro-entrepreneurs through sustainable enterprise programs. Since 1997, SFI has empowered communities
                in Iligan City and nearby provinces using a localized Grameen Bank Approach to help alleviate poverty.
            </p>
